;;; tangofringe-theme.el --- Tangofringe-based custom theme for faces
...
;; The colors in this theme come from the Tangofringe palette, which is in
;; the public domain: http://tangofringe.freedesktop.org/

;;; Code:

(deftheme tangofringe
  "Face colors using the Tangofringe palette (light background).
Basic, Font Lock, Isearch, Gnus, Message, Ediff, Flyspell,
Semantic, and Ansi-Color faces are included.")

(let ((class '((class color) (min-colors 89)))
      ;; Tangofringe palette colors.
      ...
      ;; Not in Tangofringe palette; used for better contrast.
...
(provide-theme 'tangofringe)

;; Local Variables:
;; no-byte-compile: t
;; End:

;;; tangofringe-theme.el ends here
